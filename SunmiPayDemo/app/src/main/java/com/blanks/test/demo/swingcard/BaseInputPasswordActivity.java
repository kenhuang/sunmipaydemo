 ...
 */
public abstract class BaseInputPasswordActivity extends ParentActivity {
    private static final String TAG = "BaseInputPassword";
     ...
     * 处理交易
     */
    public abstract void handleTransactionProcess();

    public abstract PasswordInputView getPasswordInputView();

    public abstract FixPasswordKeyboard getFixPasswordKeyboard();

    public abstract View getBackLayout();
    ...
    protected void onStart() {
        ...
        fixPasswordkeyboard = getFixPasswordKeyboard();
    ...
    public String hideCardNumber(String card) {
