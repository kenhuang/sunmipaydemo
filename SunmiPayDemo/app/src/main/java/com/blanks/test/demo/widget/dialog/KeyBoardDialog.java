package com.blanks.test.demo.widget.dialog;
...
public class KeyBoardDialog extends Dialog {
	...
	public static class Builder {
		...
		public KeyBoardDialog create() {
			dialog = new KeyBoardDialog(P.mContext, mTheme);
		 ...
		 * {@link #setOnDismissListener(OnDismissListener) setOnDismissListener}
		 * .
		 * </p>
		 *
		 * @return This Builder object to allow for chaining of calls to set
		...
		public Builder setShowListener(OnShowListener l) {
